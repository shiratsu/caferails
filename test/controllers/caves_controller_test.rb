...
class CavesControllerTest < ActionController::TestCase
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post :create, cafe: { address: @cafe.address, lat: @cafe.lat, lon: @cafe.lon, name: @cafe.name, url: @cafe.url }
    end
  ...
  test "should update cafe" do
    patch :update, id: @cafe, cafe: { address: @cafe.address, lat: @cafe.lat, lon: @cafe.lon, name: @cafe.name, url: @cafe.url }
    assert_redirected_to cafe_path(assigns(:cafe))
  end
